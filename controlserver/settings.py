...
OPTIX_MIGRATION_INSTALLER_PATH = os.getenv(
    "OPTIX_MIGRATION_INSTALLER_PATH", ""
).strip()
OPTIX_MIGRATION_INSTALLER_VERSION = os.getenv(
    "OPTIX_MIGRATION_INSTALLER_VERSION", ""
).strip()
OPTIX_MIGRATION_INSTALLER_BUILD = int(
    os.getenv("OPTIX_MIGRATION_INSTALLER_BUILD", "0")
)
OPTIX_MIGRATION_INSTALLER_SIZE = int(
    os.getenv("OPTIX_MIGRATION_INSTALLER_SIZE", "0")
)
OPTIX_MIGRATION_INSTALLER_SHA256 = os.getenv(
    "OPTIX_MIGRATION_INSTALLER_SHA256", ""
).strip().lower()
OPTIX_MIGRATION_INSTALLER_SIGNATURE_B64 = os.getenv(
    "OPTIX_MIGRATION_INSTALLER_SIGNATURE_B64", ""
).strip()

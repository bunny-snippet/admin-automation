...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("control", "0036_desktopofficeaccesspolicy_and_more"),
    ...
    operations = [
        migrations.AddField(
            ...
            field=models.CharField(
                blank=True,
                choices=[("", "No remote action"), ("uninstall", "Uninstall OPTIX")],
                default="",
        ...
        migrations.AddField(
            model_name="clientaccess",
            name="desktop_remote_action_acknowledged_at",
            field=models.DateTimeField(blank=True, null=True),
        ),
        migrations.AddField(
            model_name="clientaccess",
            name="desktop_remote_action_requested_at",
            field=models.DateTimeField(blank=True, null=True),
        ),
        migrations.AddField(
            model_name="clientaccess",
            name="desktop_remote_action_requested_by",
        ...
        migrations.AddField(
            model_name="clientaccess",
            name="desktop_remote_action_revision",
